                ...
                return {
                    ...
                    updateColorName(index) {
                        ...
                        if (hex) {
                            if (typeof ntc !== 'undefined') {
                                ...
                                // match[0] is the HEX of the nearest color
                                // match[1] is the NAME of the nearest color
                                this.variants[index].color = match[1];
                            } else {
                    ...
                    updateColorName(index) {
                        ...
                        if (hex) {
                            if (typeof ntc !== 'undefined') {
                                const match = ntc.name(hex);
                                this.variants[index].color = match[0]; // Set color name
                            } else {
                                // Fallback if library failed to load
                                this.variants[index].color = hex;
