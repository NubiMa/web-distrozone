<x-admin-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-1">Tambahkan karyawan kasir baru</p>
        </div>
        ...
        <form action="{{ route('admin.staff.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-6">
                ...
                <textarea name="address" id="address" required rows="3"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">{{ old('address') }}</textarea>
            </div>

            <!-- Photo -->
            <div class="mb-8">
                <label for="photo" class="block text-sm font-bold text-gray-700 mb-2">Foto Profil</label>
