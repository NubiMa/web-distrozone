                ...
                <main class="flex-1 space-y-8">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-sm border border-gray-100 flex gap-4">
                            ...
                            <div>
                                <p class="font-bold text-primary mb-1">Rumah</p>
                                <p class="text-sm text-gray-500 leading-relaxed">
                                    {{ $user->address ?? 'Belum ada alamat' }}</p>
                            </div>
                        </div>

                        <button
                            class="w-full mt-4 border border-gray-200 text-gray-600 font-bold py-2.5 rounded-sm hover:bg-gray-50 transition-colors text-sm">
                            Kelola Alamat
                        </button>
                    </div>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-gray-600 max-w-xs truncate">
                                                ...
                                                @if ($order->details->count() > 1)
                                                    <span
                                                        class="text-gray-400 text-xs">+{{ $order->details->count() - 1 }}
                                                        others</span>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4">
