            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden sticky top-24">
                ...
                <nav class="p-4 space-y-1">
                    ...
                    <a href="{{ route('orders.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm font-bold rounded-sm transition-colors {{ $active === 'orders' ? 'text-accent bg-orange-50' : 'text-gray-600 hover:text-primary hover:bg-gray-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
