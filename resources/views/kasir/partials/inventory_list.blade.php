<div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
    @forelse($products as $product)
        <div
            ...
            <!-- Left: Image & Info -->
            <div class="p-6 sm:w-2/5 flex flex-col border-b sm:border-b-0 sm:border-r border-gray-100 bg-gray-50/50">
                <div
                                ...
                                @foreach ($variants as $variant)
                                    <div
                                        ...
                                        <div class="text-right">
                                            ...
                                            <span class="text-[9px] font-bold text-gray-400 uppercase">PCS</span>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
    ...
    @empty
        <div class="col-span-full py-16 text-center bg-white rounded-3xl border border-gray-100 border-dashed">
            ...
            <p class="text-gray-500">Coba gunakan kata kunci pencarian lain.</p>
        </div>
    @endforelse
</div>
