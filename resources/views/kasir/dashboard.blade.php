<x-kasir-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="/kasir/orders"
                class="bg-white border border-border p-8 hover:border-accent transition-colors group cursor-pointer">
                ...
                <span class="inline-block bg-primary text-white px-4 py-2 text-sm font-bold uppercase">View
                    Orders</span>
            </a>

            <a href="/kasir/reports"
                class="bg-white border border-border p-8 hover:border-accent transition-colors group cursor-pointer">
                <h3 class="text-2xl font-bold text-primary group-hover:text-accent mb-4">My Reports</h3>
                <p class="text-gray-500 mb-6">View your transaction reports and performance.</p>
